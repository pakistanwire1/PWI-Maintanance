...
var API_ROUTES = {
  ...
  'addJobCard':            { auth: true,  handler: function(d) { if (d._userEmail) { var allUsers = getAllData(CONFIG.SHEET_NAMES.USERS) || []; var sessionUser = allUsers.find(function(u) { return u.Email === d._userEmail; }); if (sessionUser) { d.ComplaintByCode = d.ComplaintByCode || sessionUser.EmployeeID || ''; d.ComplaintByEmail = d.ComplaintByEmail || sessionUser.Email || d._userEmail; } else { d.ComplaintByCode = d.ComplaintByCode || ''; d.ComplaintByEmail = d.ComplaintByEmail || d._userEmail; } } var r = addJobCard(d); if (d._userEmail && d.JobCardNo) { var patch = { CreatedBy: d._userEmail, UpdatedBy: d._userEmail }; if (d.ComplaintByCode) patch.ComplaintByCode = d.ComplaintByCode; if (d.ComplaintByEmail) patch.ComplaintByEmail = d.ComplaintByEmail; updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.JobCardNo, patch); } return r; } },
  'updateJobCard':         { auth: true,  handler: function(d) { var r = updateJobCard(d.id, d); if (d._userEmail) { updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.id, { UpdatedBy: d._userEmail }); } return r; } },
  'deleteJobCard':         { auth: true,  handler: function(d) { return deleteJobCard(d.id); } },
  'startJobCard':          { auth: true,  handler: function(d) { var r = apiStartJobCard(d); if (d._userEmail) { updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.id, { UpdatedBy: d._userEmail }); } return r; } },
  'closeJobCard':          { auth: true,  handler: function(d) { var r = apiCloseJobCard(d); if (d._userEmail) { updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.id, { UpdatedBy: d._userEmail }); } return r; } },
  'approveJobCard':        { auth: true,  handler: function(d) { var r = approveJobCard(d.id, d); if (d._userEmail) { updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.id, { ApprovedBy: d._userEmail, UpdatedBy: d._userEmail }); } return r; } },
  'returnJobCard':         { auth: true,  handler: function(d) { var r = returnJobCard(d.id, d); if (d._userEmail) { updateRow(CONFIG.SHEET_NAMES.JOBCARDS, 'JobCardNo', d.id, { ReturnedBy: d._userEmail, UpdatedBy: d._userEmail }); } return r; } },
