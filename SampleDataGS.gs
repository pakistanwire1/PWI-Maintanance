...
function initializeDepartmentMaster() {
  ...
  var now = getCurrentTimestamp();
  var sampleData = [
    { DepartmentID: 'DEPT001', Department: 'Admin', DepartmentCode: 'ADM', SectionID: 'SEC001', Section: 'Admin', Division: 'Spoke Division', DepartmentHead: 'Admin Head', Description: 'Administration Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT002', Department: 'Spoke Production', DepartmentCode: 'SPR', SectionID: 'SEC002', Section: 'Spoke', Division: 'Spoke Division', DepartmentHead: 'Spoke Manager', Description: 'Spoke Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT003', Department: 'Plating Line', DepartmentCode: 'PLT', SectionID: 'SEC003', Section: 'Auto Plating Line', Division: 'Spoke Division', DepartmentHead: 'Plating Supervisor', Description: 'Auto Plating Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT004', Department: 'Nipple Production', DepartmentCode: 'NPL', SectionID: 'SEC004', Section: 'Nipple', Division: 'Spoke Division', DepartmentHead: 'Nipple Manager', Description: 'Nipple Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT005', Department: 'Packing', DepartmentCode: 'PCK', SectionID: 'SEC005', Section: 'Spoke Packing', Division: 'Spoke Division', DepartmentHead: 'Packing Supervisor', Description: 'Packing Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT006', Department: 'Spiral Production', DepartmentCode: 'SPL', SectionID: 'SEC006', Section: 'Spiral', Division: 'Control Cable Division', DepartmentHead: 'Spiral Manager', Description: 'Spiral Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT007', Department: 'PVC Production', DepartmentCode: 'PVC', SectionID: 'SEC007', Section: 'PVC', Division: 'Control Cable Division', DepartmentHead: 'PVC Manager', Description: 'PVC Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT008', Department: 'Facility Maintenance', DepartmentCode: 'MNT', SectionID: 'SEC008', Section: 'Maintenance', Division: 'Spoke Division', DepartmentHead: 'Maintenance Head', Description: 'Facility Maintenance Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT009', Department: 'Quality Control', DepartmentCode: 'QC', SectionID: 'SEC009', Section: 'Quality Control', Division: 'Spoke Division', DepartmentHead: 'Quality Manager', Description: 'Quality Control Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT010', Department: 'Warehouse', DepartmentCode: 'WRH', SectionID: 'SEC010', Section: 'Warehouse', Division: 'Spoke Division', DepartmentHead: 'Warehouse Supervisor', Description: 'Warehouse Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT011', Department: 'Stores', DepartmentCode: 'STR', SectionID: 'SEC012', Section: 'Stores', Division: 'Spoke Division', DepartmentHead: 'Store Keeper', Description: 'Spare Parts Store Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT012', Department: 'Safety', DepartmentCode: 'S&E', SectionID: 'SEC011', Section: 'Safety & Environment', Division: 'Spoke Division', DepartmentHead: 'Safety Officer', Description: 'Safety and Environment Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now }
  ];
  insertRows(sheet, fields, sampleData);
  formatSheet(sheet, fields);
  return { status: 'success', message: sheetName + ' initialized with ' + sampleData.length + ' records.', records: sampleData.length };
