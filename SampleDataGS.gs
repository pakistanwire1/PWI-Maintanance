function initializeSectionMaster() {
  ...
  var sampleData = [
    { SectionID: 'SEC001', DivisionID: 'DIV001', Section: 'Admin', SectionCode: 'ADM', Description: 'Administration & Management', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC002', DivisionID: 'DIV001', Section: 'Spoke', SectionCode: 'SPK', Description: 'Spoke Production Unit', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '2', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC003', DivisionID: 'DIV001', Section: 'Auto Plating Line', SectionCode: 'APL', Description: 'Automatic Plating Line', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC004', DivisionID: 'DIV001', Section: 'Nipple', SectionCode: 'NPL', Description: 'Nipple Production Section', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC005', DivisionID: 'DIV001', Section: 'Spoke Packing', SectionCode: 'SPP', Description: 'Spoke Packing & Dispatch', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC006', DivisionID: 'DIV002', Section: 'Spiral', SectionCode: 'SPR', Description: 'Spiral Production Line', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC007', DivisionID: 'DIV002', Section: 'PVC', SectionCode: 'PVC', Description: 'PVC Production Line', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC008', DivisionID: 'DIV001', Section: 'Maintenance', SectionCode: 'MNT', Description: 'Facility Maintenance Department', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC009', DivisionID: 'DIV001', Section: 'Quality Control', SectionCode: 'QC', Description: 'Quality Control & Inspection', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC010', DivisionID: 'DIV001', Section: 'Warehouse', SectionCode: 'WRH', Description: 'Raw Material & Finished Goods Warehouse', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC011', DivisionID: 'DIV001', Section: 'Safety & Environment', SectionCode: 'S&E', Description: 'Safety and Environmental Compliance', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '0', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { SectionID: 'SEC012', DivisionID: 'DIV001', Section: 'Stores', SectionCode: 'STR', Description: 'Spare Parts & Consumables Store', Status: 'Active', SundayOff: 'Sunday', HoursPerDay: '8', DepartmentCount: '1', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now }
  ];
...
function initializeDivisionMaster() {
  var sheetName = CONFIG.SHEET_NAMES.DIVISIONS;
  var fields = CONFIG.DIVISION_FIELDS;
  var sheet = ensureSheet(sheetName, fields);
  if (!sheet) return { status: 'error', message: 'Could not access sheet: ' + sheetName };
  if (hasDataRows(sheet)) return { status: 'skipped', message: 'Sample data already exists.' };
  var now = getCurrentTimestamp();
  var sampleData = [
    { DivisionID: 'DIV001', DivisionCode: 'SPD', DivisionName: 'Spoke Division', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DivisionID: 'DIV002', DivisionCode: 'CCD', DivisionName: 'Control Cable Division', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now }
  ];
  insertRows(sheet, fields, sampleData);
  formatSheet(sheet, fields);
  return { status: 'success', message: sheetName + ' initialized with ' + sampleData.length + ' records.', records: sampleData.length };
...
function initializeDepartmentMaster() {
  ...
  var now = getCurrentTimestamp();
  var sampleData = [
    { DepartmentID: 'DEPT001', Department: 'Admin', DepartmentCode: 'ADM', DivisionID: 'DIV001', SectionID: 'SEC001', Section: 'Admin', Division: 'Spoke Division', DepartmentHead: 'Admin Head', Description: 'Administration Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT002', Department: 'Spoke Production', DepartmentCode: 'SPR', DivisionID: 'DIV001', SectionID: 'SEC002', Section: 'Spoke', Division: 'Spoke Division', DepartmentHead: 'Spoke Manager', Description: 'Spoke Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT003', Department: 'Plating Line', DepartmentCode: 'PLT', DivisionID: 'DIV001', SectionID: 'SEC003', Section: 'Auto Plating Line', Division: 'Spoke Division', DepartmentHead: 'Plating Supervisor', Description: 'Auto Plating Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT004', Department: 'Nipple Production', DepartmentCode: 'NPL', DivisionID: 'DIV001', SectionID: 'SEC004', Section: 'Nipple', Division: 'Spoke Division', DepartmentHead: 'Nipple Manager', Description: 'Nipple Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT005', Department: 'Packing', DepartmentCode: 'PCK', DivisionID: 'DIV001', SectionID: 'SEC005', Section: 'Spoke Packing', Division: 'Spoke Division', DepartmentHead: 'Packing Supervisor', Description: 'Packing Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT006', Department: 'Spiral Production', DepartmentCode: 'SPL', DivisionID: 'DIV002', SectionID: 'SEC006', Section: 'Spiral', Division: 'Control Cable Division', DepartmentHead: 'Spiral Manager', Description: 'Spiral Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT007', Department: 'PVC Production', DepartmentCode: 'PVC', DivisionID: 'DIV002', SectionID: 'SEC007', Section: 'PVC', Division: 'Control Cable Division', DepartmentHead: 'PVC Manager', Description: 'PVC Production Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT008', Department: 'Facility Maintenance', DepartmentCode: 'MNT', DivisionID: 'DIV001', SectionID: 'SEC008', Section: 'Maintenance', Division: 'Spoke Division', DepartmentHead: 'Maintenance Head', Description: 'Facility Maintenance Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT009', Department: 'Quality Control', DepartmentCode: 'QC', DivisionID: 'DIV001', SectionID: 'SEC009', Section: 'Quality Control', Division: 'Spoke Division', DepartmentHead: 'Quality Manager', Description: 'Quality Control Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT010', Department: 'Warehouse', DepartmentCode: 'WRH', DivisionID: 'DIV001', SectionID: 'SEC010', Section: 'Warehouse', Division: 'Spoke Division', DepartmentHead: 'Warehouse Supervisor', Description: 'Warehouse Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT011', Department: 'Stores', DepartmentCode: 'STR', DivisionID: 'DIV001', SectionID: 'SEC012', Section: 'Stores', Division: 'Spoke Division', DepartmentHead: 'Store Keeper', Description: 'Spare Parts Store Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now },
    { DepartmentID: 'DEPT012', Department: 'Safety', DepartmentCode: 'S&E', DivisionID: 'DIV001', SectionID: 'SEC011', Section: 'Safety & Environment', Division: 'Spoke Division', DepartmentHead: 'Safety Officer', Description: 'Safety and Environment Department', SundayOff: 'Sunday', HoursPerDay: '8', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now }
  ];
  insertRows(sheet, fields, sampleData);
  formatSheet(sheet, fields);
  return { status: 'success', message: sheetName + ' initialized with ' + sampleData.length + ' records.', records: sampleData.length };
...
function initializeMachineMaster() {
  ...
  var now = getCurrentTimestamp();
  var sampleData = [
     { MachineID: 'MCH001', MachineCode: 'CNC-001', MachineName: 'CNC Milling Machine', MachineNumber: 'CNC-001', DivisionID: 'DIV001', DeptID: 'DEPT002', Department: 'Spoke Production', SectionID: 'SEC002', Section: 'Spoke', Location: 'Area A-1', MachineType: 'CNC', Manufacturer: 'HAAS Automation', Model: 'VF-2SS', SerialNo: 'HAAS-1001', Capacity: '500 kg', PowerRating: '50 kW', InstallDate: '2023-01-15', WarrantyExpiry: '2026-01-15', Criticality: 'Critical', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH002', MachineCode: 'CNC-002', MachineName: 'CNC Turning Center', MachineNumber: 'CNC-002', DivisionID: 'DIV001', DeptID: 'DEPT002', Department: 'Spoke Production', SectionID: 'SEC002', Section: 'Spoke', Location: 'Area A-2', MachineType: 'CNC', Manufacturer: 'HAAS Automation', Model: 'ST-20', SerialNo: 'HAAS-1002', Capacity: '400 kg', PowerRating: '45 kW', InstallDate: '2023-03-20', WarrantyExpiry: '2026-03-20', Criticality: 'Critical', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH003', MachineCode: 'HP-001', MachineName: 'Hydraulic Press 100T', MachineNumber: 'HP-001', DivisionID: 'DIV001', DeptID: 'DEPT002', Department: 'Spoke Production', SectionID: 'SEC002', Section: 'Spoke', Location: 'Area B-1', MachineType: 'Hydraulic', Manufacturer: 'Enerpac', Model: 'EP-100', SerialNo: 'EP-2001', Capacity: '100 T', PowerRating: '75 kW', InstallDate: '2022-06-10', WarrantyExpiry: '2025-06-10', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH004', MachineCode: 'HP-002', MachineName: 'Hydraulic Press 50T', MachineNumber: 'HP-002', DivisionID: 'DIV001', DeptID: 'DEPT004', Department: 'Nipple Production', SectionID: 'SEC004', Section: 'Nipple', Location: 'Area B-2', MachineType: 'Hydraulic', Manufacturer: 'Enerpac', Model: 'EP-50', SerialNo: 'EP-2002', Capacity: '50 T', PowerRating: '40 kW', InstallDate: '2022-08-15', WarrantyExpiry: '2025-08-15', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH005', MachineCode: 'AC-001', MachineName: 'Screw Air Compressor', MachineNumber: 'AC-001', DivisionID: 'DIV001', DeptID: 'DEPT008', Department: 'Facility Maintenance', SectionID: 'SEC008', Section: 'Maintenance', Location: 'Utility Room', MachineType: 'Compressor', Manufacturer: 'Atlas Copco', Model: 'GA-30VSD', SerialNo: 'AC-3001', Capacity: '200 CFM', PowerRating: '150 kW', InstallDate: '2023-05-01', WarrantyExpiry: '2026-05-01', Criticality: 'Critical', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH006', MachineCode: 'AC-002', MachineName: 'Piston Air Compressor', MachineNumber: 'AC-002', DivisionID: 'DIV001', DeptID: 'DEPT008', Department: 'Facility Maintenance', SectionID: 'SEC008', Section: 'Maintenance', Location: 'Utility Room', MachineType: 'Compressor', Manufacturer: 'Ingersoll Rand', Model: 'SSR-50', SerialNo: 'IR-5001', Capacity: '100 CFM', PowerRating: '75 kW', InstallDate: '2023-07-20', WarrantyExpiry: '2026-07-20', Criticality: 'Medium', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH007', MachineCode: 'CB-001', MachineName: 'Main Conveyor Belt', MachineNumber: 'CB-001', DivisionID: 'DIV001', DeptID: 'DEPT005', Department: 'Packing', SectionID: 'SEC005', Section: 'Spoke Packing', Location: 'Packing Area', MachineType: 'Conveyor', Manufacturer: 'Fenner Dunlop', Model: 'FD-500', SerialNo: 'FD-7001', Capacity: '100 m', PowerRating: '5 kW', InstallDate: '2021-11-01', WarrantyExpiry: '2024-11-01', Criticality: 'Medium', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 12, OperatingDaysPerWeek: 6 },
     { MachineID: 'MCH008', MachineCode: 'CB-002', MachineName: 'Packing Conveyor Belt', MachineNumber: 'CB-002', DivisionID: 'DIV001', DeptID: 'DEPT005', Department: 'Packing', SectionID: 'SEC005', Section: 'Spoke Packing', Location: 'Packing Area', MachineType: 'Conveyor', Manufacturer: 'Fenner Dunlop', Model: 'FD-300', SerialNo: 'FD-7002', Capacity: '50 m', PowerRating: '3 kW', InstallDate: '2022-02-15', WarrantyExpiry: '2025-02-15', Criticality: 'Low', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 12, OperatingDaysPerWeek: 6 },
     { MachineID: 'MCH009', MachineCode: 'GEN-001', MachineName: 'Diesel Generator 500kVA', MachineNumber: 'GEN-001', DivisionID: 'DIV001', DeptID: 'DEPT008', Department: 'Facility Maintenance', SectionID: 'SEC008', Section: 'Maintenance', Location: 'Generator Room', MachineType: 'Generator', Manufacturer: 'Cummins India', Model: 'C20D5', SerialNo: 'CUM-9001', Capacity: '500 kVA', PowerRating: '400 kW', InstallDate: '2023-01-01', WarrantyExpiry: '2026-01-01', Criticality: 'Critical', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH010', MachineCode: 'PUMP-001', MachineName: 'Coolant Pump Station', MachineNumber: 'PUMP-001', DivisionID: 'DIV001', DeptID: 'DEPT003', Department: 'Plating Line', SectionID: 'SEC003', Section: 'Auto Plating Line', Location: 'Plating Area', MachineType: 'Pump', Manufacturer: 'Kirloskar Brothers', Model: 'KOS-150', SerialNo: 'KBL-5001', Capacity: '150 LPM', PowerRating: '25 kW', InstallDate: '2022-09-10', WarrantyExpiry: '2025-09-10', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH011', MachineCode: 'PLT-001', MachineName: 'Auto Plating Line', MachineNumber: 'PLT-001', DivisionID: 'DIV001', DeptID: 'DEPT003', Department: 'Plating Line', SectionID: 'SEC003', Section: 'Auto Plating Line', Location: 'Plating Area', MachineType: 'Robotic', Manufacturer: 'Grauer & Weil', Model: 'GW-2000', SerialNo: 'GW-3001', Capacity: '2000 kg/hr', PowerRating: '250 kW', InstallDate: '2023-04-01', WarrantyExpiry: '2028-04-01', Criticality: 'Critical', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH012', MachineCode: 'BOIL-001', MachineName: 'Steam Boiler', MachineNumber: 'BOIL-001', DivisionID: 'DIV001', DeptID: 'DEPT008', Department: 'Facility Maintenance', SectionID: 'SEC008', Section: 'Maintenance', Location: 'Boiler Room', MachineType: 'Other', Manufacturer: 'Thermax', Model: 'TB-2000', SerialNo: 'THX-6001', Capacity: '2000 kg/hr', PowerRating: '150 kW', InstallDate: '2022-12-01', WarrantyExpiry: '2025-12-01', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH013', MachineCode: 'SPL-001', MachineName: 'Spiral Winding Machine', MachineNumber: 'SPL-001', DivisionID: 'DIV002', DeptID: 'DEPT006', Department: 'Spiral Production', SectionID: 'SEC006', Section: 'Spiral', Location: 'Spiral Area', MachineType: 'Mechanical', Manufacturer: 'Mitsubishi', Model: 'SW-500', SerialNo: 'MIT-8001', Capacity: '500 units/hr', PowerRating: '100 kW', InstallDate: '2023-06-15', WarrantyExpiry: '2026-06-15', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH014', MachineCode: 'PVC-001', MachineName: 'PVC Extrusion Machine', MachineNumber: 'PVC-001', DivisionID: 'DIV002', DeptID: 'DEPT007', Department: 'PVC Production', SectionID: 'SEC007', Section: 'PVC', Location: 'PVC Area', MachineType: 'Mechanical', Manufacturer: 'Battenfeld', Model: 'BE-100', SerialNo: 'BTF-4001', Capacity: '200 kg/hr', PowerRating: '80 kW', InstallDate: '2023-02-20', WarrantyExpiry: '2026-02-20', Criticality: 'High', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
     { MachineID: 'MCH015', MachineCode: 'DRY-001', MachineName: 'Air Dryer Unit', MachineNumber: 'DRY-001', DivisionID: 'DIV001', DeptID: 'DEPT008', Department: 'Facility Maintenance', SectionID: 'SEC008', Section: 'Maintenance', Location: 'Utility Room', MachineType: 'Pneumatic', Manufacturer: 'Atlas Copco', Model: 'CD-90', SerialNo: 'AC-9001', Capacity: '200 CFM', PowerRating: '5 kW', InstallDate: '2023-05-01', WarrantyExpiry: '2026-05-01', Criticality: 'Medium', Status: 'Active', CreatedBy: 'admin@cmms.com', CreatedAt: now, UpdatedBy: 'admin@cmms.com', UpdatedAt: now, OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 }
   ];
  insertRows(sheet, fields, sampleData);
  formatSheet(sheet, fields);
  return { status: 'success', message: sheetName + ' initialized with ' + sampleData.length + ' records.', records: sampleData.length };
...
function initializeAllSampleData() {
  ...
  var results = [];
  var fns = [
    { name: 'Divisions', fn: initializeDivisionMaster },
  ...
  if (isNew) {
    ...
    for (var si = 0; si < srcCandidates.length; si++) {
      if (ss2.getSheetByName(srcCandidates[si])) {
        applySheetFormatting(sheet, srcCandidates[si]);
        Logger.log(sheetName + ' formatting cloned from ' + srcCandidates[si]);
        break;
      }
    }
  }
