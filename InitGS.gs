...
function setupTestData() {
  ...
  var testMachines = [
    { MachineName: 'CNC Milling Machine', MachineCode: 'CNC-001', MachineNumber: 'CNC-001', MachineType: 'CNC', DeptID: 'DEPT001', Department: 'Production', SectionID: 'SEC001', Section: 'Section A', Location: 'Area A', Manufacturer: 'HAAS', Model: 'VF-2', SerialNo: 'HAAS-001', Capacity: '500 kg', PowerRating: '50 kW', Criticality: 'Critical', Status: 'Active', OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
    { MachineName: 'Hydraulic Press', MachineCode: 'HP-001', MachineNumber: 'HP-001', MachineType: 'Hydraulic', DeptID: 'DEPT001', Department: 'Production', SectionID: 'SEC001', Section: 'Section A', Location: 'Area B', Manufacturer: 'Enerpac', Model: 'EP-100', SerialNo: 'EP-001', Capacity: '100 T', PowerRating: '75 kW', Criticality: 'High', Status: 'Active', OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
    { MachineName: 'Air Compressor', MachineCode: 'AC-001', MachineNumber: 'AC-001', MachineType: 'Compressor', DeptID: 'DEPT003', Department: 'Engineering', SectionID: 'SEC003', Section: 'Section C', Location: 'Utility', Manufacturer: 'Atlas Copco', Model: 'GA-30', SerialNo: 'AC-001', Capacity: '200 CFM', PowerRating: '150 kW', Criticality: 'Medium', Status: 'Active', OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 },
    { MachineName: 'Conveyor Belt', MachineCode: 'CB-001', MachineNumber: 'CB-001', MachineType: 'Conveyor', DeptID: 'DEPT001', Department: 'Production', SectionID: 'SEC001', Section: 'Section A', Location: 'Area A', Capacity: '100 m', PowerRating: '5 kW', Criticality: 'Low', Status: 'Active', OperatingHoursPerDay: 12, OperatingDaysPerWeek: 6 },
    { MachineName: 'Generator Set', MachineCode: 'GEN-001', MachineNumber: 'GEN-001', MachineType: 'Generator', DeptID: 'DEPT003', Department: 'Engineering', SectionID: 'SEC003', Section: 'Section C', Location: 'Utility', Manufacturer: 'Cummins', Model: 'C20D5', SerialNo: 'GEN-001', Capacity: '500 kVA', PowerRating: '400 kW', Criticality: 'Critical', Status: 'Active', OperatingHoursPerDay: 24, OperatingDaysPerWeek: 7 }
  ];
